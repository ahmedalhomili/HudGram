...
public abstract class BaseHudSettingsActivity extends BaseFragment {
    ...
    public String getString(String key) {
        ...
        switch (key) {
            ...
            case "HudScheduledMessagesTitle": return LocaleController.getString("HudScheduledMessagesTitle", R.string.HudScheduledMessagesTitle);
            case "HudScheduledMessagesRow": return LocaleController.getString("HudScheduledMessagesRow", R.string.HudScheduledMessagesRow);
            case "HudScheduledMessagesRowAbout": return LocaleController.getString("HudScheduledMessagesRowAbout", R.string.HudScheduledMessagesRowAbout);
            case "HudScheduledMessagesEmpty": return LocaleController.getString("HudScheduledMessagesEmpty", R.string.HudScheduledMessagesEmpty);
            case "HudScheduledMessagesDeleteTitle": return LocaleController.getString("HudScheduledMessagesDeleteTitle", R.string.HudScheduledMessagesDeleteTitle);
            case "HudScheduledMessagesDeleteConfirm": return LocaleController.getString("HudScheduledMessagesDeleteConfirm", R.string.HudScheduledMessagesDeleteConfirm);
            case "HudScheduledMessagesDeleted": return LocaleController.getString("HudScheduledMessagesDeleted", R.string.HudScheduledMessagesDeleted);
            case "HudScheduledMessagesAdded": return LocaleController.getString("HudScheduledMessagesAdded", R.string.HudScheduledMessagesAdded);
            case "HudScheduledMessagesSelectChats": return LocaleController.getString("HudScheduledMessagesSelectChats", R.string.HudScheduledMessagesSelectChats);
            case "HudScheduledMessagesSelectChatsDetail": return LocaleController.getString("HudScheduledMessagesSelectChatsDetail", R.string.HudScheduledMessagesSelectChatsDetail);
            case "HudScheduledMessagesDate": return LocaleController.getString("HudScheduledMessagesDate", R.string.HudScheduledMessagesDate);
            case "HudScheduledMessagesTime": return LocaleController.getString("HudScheduledMessagesTime", R.string.HudScheduledMessagesTime);
            case "HudScheduledMessagesMsgHint": return LocaleController.getString("HudScheduledMessagesMsgHint", R.string.HudScheduledMessagesMsgHint);
            case "HudScheduledMessagesFillFields": return LocaleController.getString("HudScheduledMessagesFillFields", R.string.HudScheduledMessagesFillFields);
            case "HudScheduledMessagesInvalidTime": return LocaleController.getString("HudScheduledMessagesInvalidTime", R.string.HudScheduledMessagesInvalidTime);
            case "HudScheduledMessagesHelpTitle": return LocaleController.getString("HudScheduledMessagesHelpTitle", R.string.HudScheduledMessagesHelpTitle);
            case "HudScheduledMessagesHelpText": return LocaleController.getString("HudScheduledMessagesHelpText", R.string.HudScheduledMessagesHelpText);
            case "HudScheduledMessagesEnabled": return LocaleController.getString("HudScheduledMessagesEnabled", R.string.HudScheduledMessagesEnabled);
            case "HudScheduledMessagesDisabled": return LocaleController.getString("HudScheduledMessagesDisabled", R.string.HudScheduledMessagesDisabled);
            case "HudScheduledMessagesFeatureDisabled": return LocaleController.getString("HudScheduledMessagesFeatureDisabled", R.string.HudScheduledMessagesFeatureDisabled);
            case "HudScheduledMessagesTimeSettings": return LocaleController.getString("HudScheduledMessagesTimeSettings", R.string.HudScheduledMessagesTimeSettings);
            case "HudScheduledMessagesRepeat": return LocaleController.getString("HudScheduledMessagesRepeat", R.string.HudScheduledMessagesRepeat);
            case "HudScheduledMessagesRepeatNever": return LocaleController.getString("HudScheduledMessagesRepeatNever", R.string.HudScheduledMessagesRepeatNever);
            case "HudScheduledMessagesRepeatDaily": return LocaleController.getString("HudScheduledMessagesRepeatDaily", R.string.HudScheduledMessagesRepeatDaily);
            case "HudScheduledMessagesRepeatWeekly": return LocaleController.getString("HudScheduledMessagesRepeatWeekly", R.string.HudScheduledMessagesRepeatWeekly);
            case "HudScheduledMessagesRepeatMonthly": return LocaleController.getString("HudScheduledMessagesRepeatMonthly", R.string.HudScheduledMessagesRepeatMonthly);
            case "HudScheduledMessagesRepeatCustom": return LocaleController.getString("HudScheduledMessagesRepeatCustom", R.string.HudScheduledMessagesRepeatCustom);
            case "HudScheduledMessagesRepeatEnterHours": return LocaleController.getString("HudScheduledMessagesRepeatEnterHours", R.string.HudScheduledMessagesRepeatEnterHours);
            case "HudScheduledMessagesTemplates": return LocaleController.getString("HudScheduledMessagesTemplates", R.string.HudScheduledMessagesTemplates);
            case "HudScheduledMessagesTemplateSave": return LocaleController.getString("HudScheduledMessagesTemplateSave", R.string.HudScheduledMessagesTemplateSave);
            case "HudScheduledMessagesTemplateSaved": return LocaleController.getString("HudScheduledMessagesTemplateSaved", R.string.HudScheduledMessagesTemplateSaved);
            case "HudScheduledMessagesTemplateDeleted": return LocaleController.getString("HudScheduledMessagesTemplateDeleted", R.string.HudScheduledMessagesTemplateDeleted);
            case "HudScheduledMessagesTemplateDeleteConfirm": return LocaleController.getString("HudScheduledMessagesTemplateDeleteConfirm", R.string.HudScheduledMessagesTemplateDeleteConfirm);
            case "HudScheduledMessagesHistoryHeader": return LocaleController.getString("HudScheduledMessagesHistoryHeader", R.string.HudScheduledMessagesHistoryHeader);
            case "HudScheduledMessagesHistoryLog": return LocaleController.getString("HudScheduledMessagesHistoryLog", R.string.HudScheduledMessagesHistoryLog);
            case "HudScheduledMessagesHistoryLogEmpty": return LocaleController.getString("HudScheduledMessagesHistoryLogEmpty", R.string.HudScheduledMessagesHistoryLogEmpty);
            case "HudScheduledMessagesHistoryClear": return LocaleController.getString("HudScheduledMessagesHistoryClear", R.string.HudScheduledMessagesHistoryClear);
            case "HudScheduledMessagesHistoryCleared": return LocaleController.getString("HudScheduledMessagesHistoryCleared", R.string.HudScheduledMessagesHistoryCleared);
            case "HudScheduledMessagesEditAction": return LocaleController.getString("HudScheduledMessagesEditAction", R.string.HudScheduledMessagesEditAction);
            case "HudScheduledMessagesTapToChangeTime": return LocaleController.getString("HudScheduledMessagesTapToChangeTime", R.string.HudScheduledMessagesTapToChangeTime);
            case "HudScheduledMessagesTapToChangeRepeat": return LocaleController.getString("HudScheduledMessagesTapToChangeRepeat", R.string.HudScheduledMessagesTapToChangeRepeat);
            case "HudScheduledMessagesTemplateOptions": return LocaleController.getString("HudScheduledMessagesTemplateOptions", R.string.HudScheduledMessagesTemplateOptions);
            ...
            case "HudAutoReplyDMRow": return LocaleController.getString("HudAutoReplyDMRow", R.string.HudAutoReplyDMRow);
            case "HudAutoReplyDMTitle": return LocaleController.getString("HudAutoReplyDMTitle", R.string.HudAutoReplyDMTitle);
            case "HudAutoReplyDMEnabled": return LocaleController.getString("HudAutoReplyDMEnabled", R.string.HudAutoReplyDMEnabled);
            case "HudAutoReplyDMDisabledBanner": return LocaleController.getString("HudAutoReplyDMDisabledBanner", R.string.HudAutoReplyDMDisabledBanner);
            case "HudAutoReplyDMEmpty": return LocaleController.getString("HudAutoReplyDMEmpty", R.string.HudAutoReplyDMEmpty);
            case "HudAutoReplyDMSaved": return LocaleController.getString("HudAutoReplyDMSaved", R.string.HudAutoReplyDMSaved);
            case "HudAutoReplyDMDeleted": return LocaleController.getString("HudAutoReplyDMDeleted", R.string.HudAutoReplyDMDeleted);
            case "HudAutoReplyDMDeleteConfirm": return LocaleController.getString("HudAutoReplyDMDeleteConfirm", R.string.HudAutoReplyDMDeleteConfirm);
            case "HudAutoReplyDMRuleName": return LocaleController.getString("HudAutoReplyDMRuleName", R.string.HudAutoReplyDMRuleName);
            case "HudAutoReplyDMRuleNameHint": return LocaleController.getString("HudAutoReplyDMRuleNameHint", R.string.HudAutoReplyDMRuleNameHint);
            case "HudAutoReplyDMMatchHeader": return LocaleController.getString("HudAutoReplyDMMatchHeader", R.string.HudAutoReplyDMMatchHeader);
            case "HudAutoReplyDMMatchAll": return LocaleController.getString("HudAutoReplyDMMatchAll", R.string.HudAutoReplyDMMatchAll);
            case "HudAutoReplyDMMatchContains": return LocaleController.getString("HudAutoReplyDMMatchContains", R.string.HudAutoReplyDMMatchContains);
            case "HudAutoReplyDMMatchEquals": return LocaleController.getString("HudAutoReplyDMMatchEquals", R.string.HudAutoReplyDMMatchEquals);
            case "HudAutoReplyDMKeyword": return LocaleController.getString("HudAutoReplyDMKeyword", R.string.HudAutoReplyDMKeyword);
            case "HudAutoReplyDMKeywordHint": return LocaleController.getString("HudAutoReplyDMKeywordHint", R.string.HudAutoReplyDMKeywordHint);
            case "HudAutoReplyDMReplyHeader": return LocaleController.getString("HudAutoReplyDMReplyHeader", R.string.HudAutoReplyDMReplyHeader);
            case "HudAutoReplyDMReplyHint": return LocaleController.getString("HudAutoReplyDMReplyHint", R.string.HudAutoReplyDMReplyHint);
            case "HudAutoReplyDMReplyMode": return LocaleController.getString("HudAutoReplyDMReplyMode", R.string.HudAutoReplyDMReplyMode);
            case "HudAutoReplyDMReplyModeSingle": return LocaleController.getString("HudAutoReplyDMReplyModeSingle", R.string.HudAutoReplyDMReplyModeSingle);
            case "HudAutoReplyDMReplyModeMultiple": return LocaleController.getString("HudAutoReplyDMReplyModeMultiple", R.string.HudAutoReplyDMReplyModeMultiple);
            case "HudAutoReplyDMReplyModeSmart": return LocaleController.getString("HudAutoReplyDMReplyModeSmart", R.string.HudAutoReplyDMReplyModeSmart);
            case "HudAutoReplyDMManageTexts": return LocaleController.getString("HudAutoReplyDMManageTexts", R.string.HudAutoReplyDMManageTexts);
            case "HudAutoReplyDMSmartMorning": return LocaleController.getString("HudAutoReplyDMSmartMorning", R.string.HudAutoReplyDMSmartMorning);
            case "HudAutoReplyDMSmartAfternoon": return LocaleController.getString("HudAutoReplyDMSmartAfternoon", R.string.HudAutoReplyDMSmartAfternoon);
            case "HudAutoReplyDMSmartEvening": return LocaleController.getString("HudAutoReplyDMSmartEvening", R.string.HudAutoReplyDMSmartEvening);
            case "HudAutoReplyDMSmartNight": return LocaleController.getString("HudAutoReplyDMSmartNight", R.string.HudAutoReplyDMSmartNight);
            case "HudAutoReplyDMDelay": return LocaleController.getString("HudAutoReplyDMDelay", R.string.HudAutoReplyDMDelay);
            case "HudAutoReplyDMDelayAbout": return LocaleController.getString("HudAutoReplyDMDelayAbout", R.string.HudAutoReplyDMDelayAbout);
            case "HudAutoReplyDMScopeHeader": return LocaleController.getString("HudAutoReplyDMScopeHeader", R.string.HudAutoReplyDMScopeHeader);
            case "HudAutoReplyDMScopeBoth": return LocaleController.getString("HudAutoReplyDMScopeBoth", R.string.HudAutoReplyDMScopeBoth);
            case "HudAutoReplyDMScopeGroups": return LocaleController.getString("HudAutoReplyDMScopeGroups", R.string.HudAutoReplyDMScopeGroups);
            case "HudAutoReplyDMScopeContacts": return LocaleController.getString("HudAutoReplyDMScopeContacts", R.string.HudAutoReplyDMScopeContacts);
            case "HudAutoReplyDMAdvancedHeader": return LocaleController.getString("HudAutoReplyDMAdvancedHeader", R.string.HudAutoReplyDMAdvancedHeader);
            case "HudAutoReplyDMFirstOnly": return LocaleController.getString("HudAutoReplyDMFirstOnly", R.string.HudAutoReplyDMFirstOnly);
            case "HudAutoReplyDMFirstOnlyAbout": return LocaleController.getString("HudAutoReplyDMFirstOnlyAbout", R.string.HudAutoReplyDMFirstOnlyAbout);
            case "HudAutoReplyDMExcludeBots": return LocaleController.getString("HudAutoReplyDMExcludeBots", R.string.HudAutoReplyDMExcludeBots);
            case "HudAutoReplyDMExcludeForwarded": return LocaleController.getString("HudAutoReplyDMExcludeForwarded", R.string.HudAutoReplyDMExcludeForwarded);
            case "HudAutoReplyDMCooldown": return LocaleController.getString("HudAutoReplyDMCooldown", R.string.HudAutoReplyDMCooldown);
            case "HudAutoReplyDMScheduleHeader": return LocaleController.getString("HudAutoReplyDMScheduleHeader", R.string.HudAutoReplyDMScheduleHeader);
            case "HudAutoReplyDMScheduleEnabled": return LocaleController.getString("HudAutoReplyDMScheduleEnabled", R.string.HudAutoReplyDMScheduleEnabled);
            case "HudAutoReplyDMScheduleFrom": return LocaleController.getString("HudAutoReplyDMScheduleFrom", R.string.HudAutoReplyDMScheduleFrom);
            case "HudAutoReplyDMScheduleTo": return LocaleController.getString("HudAutoReplyDMScheduleTo", R.string.HudAutoReplyDMScheduleTo);
            case "HudAutoReplyDMFilterHeader": return LocaleController.getString("HudAutoReplyDMFilterHeader", R.string.HudAutoReplyDMFilterHeader);
            case "HudAutoReplyDMFilterAll": return LocaleController.getString("HudAutoReplyDMFilterAll", R.string.HudAutoReplyDMFilterAll);
            case "HudAutoReplyDMFilterWhitelist": return LocaleController.getString("HudAutoReplyDMFilterWhitelist", R.string.HudAutoReplyDMFilterWhitelist);
            case "HudAutoReplyDMFilterBlacklist": return LocaleController.getString("HudAutoReplyDMFilterBlacklist", R.string.HudAutoReplyDMFilterBlacklist);
            case "HudAutoReplyDMFilterManage": return LocaleController.getString("HudAutoReplyDMFilterManage", R.string.HudAutoReplyDMFilterManage);
            case "HudAutoReplyDMLogHeader": return LocaleController.getString("HudAutoReplyDMLogHeader", R.string.HudAutoReplyDMLogHeader);
            case "HudAutoReplyDMLog": return LocaleController.getString("HudAutoReplyDMLog", R.string.HudAutoReplyDMLog);
            case "HudAutoReplyDMLogEmpty": return LocaleController.getString("HudAutoReplyDMLogEmpty", R.string.HudAutoReplyDMLogEmpty);
            case "HudAutoReplyDMLogClear": return LocaleController.getString("HudAutoReplyDMLogClear", R.string.HudAutoReplyDMLogClear);
            case "HudAutoReplyDMLogCleared": return LocaleController.getString("HudAutoReplyDMLogCleared", R.string.HudAutoReplyDMLogCleared);
            case "HudAutoReplyDMHelpTitle": return LocaleController.getString("HudAutoReplyDMHelpTitle", R.string.HudAutoReplyDMHelpTitle);
            case "HudAutoReplyDMHelpText": return LocaleController.getString("HudAutoReplyDMHelpText", R.string.HudAutoReplyDMHelpText);
            case "HudAutoReplyDMDuplicate": return LocaleController.getString("HudAutoReplyDMDuplicate", R.string.HudAutoReplyDMDuplicate);
        }
        return key;
    }
