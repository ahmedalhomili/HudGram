...
abstract class GenerateSchemeTask : DefaultTask() {
    ...
    fun generate() {
        ...
        val tlSchemaFilter = tlSchemaFull.applyRules(RulesConfig.rules)
        ...
        val dep = RulesConfig.rules.databaseTypes
    ...
    private fun generateSchemeClassForType(
        ...
        for (constructor in constructors) {
            ...
            if (!RulesConfig.rules.filterConstructor(constructor.tl.key.name)) continue
